...
void set_sim_keyword(int *num_dict,WORD **dict)
{
  ...
  *dict = (WORD *)cmalloc(NUM_DICT_SIM*sizeof(WORD));
  ...
  strcpy((*dict)[80],"zmin_extern");
  strcpy((*dict)[81],"zmax_extern");
  strcpy((*dict)[82],"nres_nhc");
  strcpy((*dict)[83],"yoshidas");
  strcpy((*dict)[84],"scale_vdw");
  strcpy((*dict)[85],"scale_charge");
  strcpy((*dict)[86],"iwr_eigen_values");
  strcpy((*dict)[87],"partratio_file");
  strcpy((*dict)[88],"nma_type");
  strcpy((*dict)[89],"polar");

  strcpy((*dict)[90],"ncolvar");
  strcpy((*dict)[91],"hilldepth");
  strcpy((*dict)[92],"colvarcntrfile");
  strcpy((*dict)[93],"iwr_colv");    
  strcpy((*dict)[94],"colv_file");    
  strcpy((*dict)[95],"minstephill");    
  strcpy((*dict)[96],"maxstephill");    
  strcpy((*dict)[97],"hill_file");    
  strcpy((*dict)[98],"tunehills");    
  strcpy((*dict)[99],"scaletemp");    
}
