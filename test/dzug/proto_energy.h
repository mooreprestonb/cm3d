...
void exclude_bendquarts(int *,int **,BENDQUART *);
void fbendquart(SIMPARMS *,COORDS *);
void getvbendquart(SIMPARMS *,COORDS *,double *,double *,double [9]);
double potbendquart(double *,double *,double *);
